...
public class SuperCircleView extends View {
    ...
    public SuperCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinCircleColor = a.getColor(R.styleable.SuperCircleView_circle_color, Color.TRANSPARENT);
        mMaxCircleColor = a.getColor(R.styleable.SuperCircleView_max_circle_color, ContextCompat.getColor(getContext(),R.color.colorAccent));
        mRingNormalColor = a.getColor(R.styleable.SuperCircleView_ring_normal_color, Color.RED);
        ...
        color[0] = Color.parseColor("#999999");
        color[1] = Color.parseColor("#999999");
        color[2] = Color.parseColor("#999999");
    }
    ...
    private void drawColorRing(Canvas canvas) {
        ...
        ringColorPaint.setColor(0xFF999999);
    ...
    private void drawNormalRing(Canvas canvas) {
        ...
        ringNormalPaint.setColor(0xFF999999);
        canvas.drawArc(mRectF, 270, 360, false, ringNormalPaint);
        if (!isShowSelect) {
            return;
        }
        ringNormalPaint.setColor(0xFF000000);
